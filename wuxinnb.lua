...
local Window = OrionLib:MakeWindow({Name = "雾新脚本", HidePremium = false, SaveConfig = false, IntroText = "注入器："..identifyexecutor(), ConfigFolder = "雾新脚本"})
...
Tab:AddButton({
	Name = "彩虹朋友",
	Callback = function()
      	loadstring(game:HttpGet("loadstring(game:HttpGet("https://raw.githubusercontent.com/114514541883484/wuxin666/main/%E5%BD%A9%E8%99%B9%E6%9C%8B%E5%8F%8B.txt",true))()",true))()
  	end    
})
